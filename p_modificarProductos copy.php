...
<!-- <script src="js/modificarProductosCache.js" ></script> -->
...
datos.append("cod_interno", inpCodigo);
datos.append("nombre", inpNombre);
datos.append("descripcion", inpDesc);
datos.append("precio", parseFloat(inpPrecio.replace(/[^0-9.]/g, "")));
datos.append("cod_provedor", inpCodProv);
datos.append("ruta_imagen", previewImg.src);
...
.then(res => res.text())
.then(resp => console.log("Servidor:", resp));
